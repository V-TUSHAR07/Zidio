...
const sortOptions = [
  ...
  { name: "Most Applied", href: "#", current: false },
];
...
const filters = [
  {
    ...
    options: [
      ...
      { value: "san-francisco", label: "San Francisco", checked: true },
      { value: "los-angeles", label: "Los Angeles", checked: false },
    ],
  },
  {
    id: "job-type",
  ...
  },
  {
    ...
    options: [
      ...
      { value: "mid", label: "Mid Level", checked: true },
      { value: "senior", label: "Senior Level", checked: false },
    ],
  },
];
...
const jobs = [
  {
    ...
    description:
      "Join our dynamic team and work on cutting-edge technologies to build innovative solutions.",
    tags: ["software", "engineering", "full-time"],
    imageSrc: "/path/to/job-image1.jpg",
  },
  {
    ...
    description:
      "Lead our product team to create impactful and user-friendly products.",
    tags: ["product", "management", "leadership"],
    imageSrc: "/path/to/job-image2.jpg",
  },
  {
    ...
    imageSrc: "/path/to/job-image3.jpg",
  },
  {
    jobTitle: "UX Designer",
    companyName: "Design Works",
